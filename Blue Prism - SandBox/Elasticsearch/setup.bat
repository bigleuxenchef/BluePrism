...
set ELKMASTERHOSTNAME=mbp15.local
set ELKMASTERPORT=9200
set JDBC_DRIVER_LIBRARY=C:\Program Files\Microsoft JDBC Driver 6.0 for SQL Server\sqljdbc_6.0\enu\jre8\sqljdbc42.jar
set JDBC_DRIVER_CLASS=com.microsoft.sqlserver.jdbc.SQLServerDriver
set SQLSERVERHOSTNAME=localhost
set SQLSERVERPORT=1433
set SQLSERVERINSTANCE=SQLEXPRESS
set LOGSTASH_HOME=C:\Users\rumi\downloads\logstash-5.5.1
set JDBC_USER=rumi
...
IF NOT "%JAVA_OPTS%" == "" (
    ...
    SET JAVA_OPTS=%JAVA_OPTS% -Djava.library.path="C:\\Windows\\System32\\"
    SET JAVA_OPTS=%JAVA_OPTS% -Dcom.sun.management.jmxremote=true
    SET JAVA_OPTS=%JAVA_OPTS% -Dcom.sun.management.jmxremote.port=1234
    SET JAVA_OPTS=%JAVA_OPTS% -Dcom.sun.management.jmxremote.ssl=false
    SET JAVA_OPTS=%JAVA_OPTS% -Dcom.sun.management.jmxremote.local.only=false
    SET JAVA_OPTS=%JAVA_OPTS% -Dcom.sun.management.jmxremote.authenticate=false
    SET JAVA_OPTS=%JAVA_OPTS% -Djava.rmi.server.hostname=192.168.56.118 -D64
    REM SET JAVA_OPTS=%JAVA_OPTS% -Dcom.sun.management.jmxremote.rmi.port=1099
